  ...
  return (
    <header className="h-16 px-6 flex items-center justify-between bg-[rgb(var(--card))] border-b border-[rgb(var(--border))]">
      ...
      <div className="flex items-center gap-4">
        <span className="font-bold">Balenzi Phillip</span>
        {/* Theme toggle */}
        <button
        ...
        {/* User icon */}
        <button onClick={() => setOpen(!open)} className="p-2 rounded-full hover:bg-slate-100">
          <UserCircle className="w-7 h-7" />
        </button>

        {/* Dropdown */}
        {open && (
          <div className="absolute right-0 mt-2 w-64 rounded-xl shadow-lg bg-blue-600 dark:border-blue-700">
            <div className="px-4 py-3 border-b dark:border-blue-700">
              ...
              <p className="text-sm text-white"><span className="text-white font-bold">Role:</span> {user.role}</p>
            </div>
